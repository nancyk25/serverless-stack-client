...
export default function Signup(props) {
  ...
  //1. Set loading state
  //2. make a call to signup a user - this creates a new user object
  //3. save that object to set new user
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      /**
       * Handling refresh while signing up
    ...
    //1. Set loading state
    //2. use confirmation code to confirm user
    //3. Authenticate user and sign them in
    //4. Finally redirect to homepage
